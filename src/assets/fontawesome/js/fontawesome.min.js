...
!(function () {
    ...
    function e(t, a) {
        if (t) {
            ...
            return 'Map' === (e = 'Object' === e && t.constructor ? t.constructor.name : e) ||
                'Set' === e
                ? Array.from(t)
            ...
            delete e[0].attributes.id,
                e[0].attributes.class &&
                    ((t = e[0].attributes.class.split(' ').reduce(
                        function (t, a) {
                            return (
                                (a === J.replacementClass || a.match(n) ? t.toSvg : t.toNode).push(
                                    a
                                ),
                                t
                            );
        ...
        return new Promise(function (e, t) {
            ...
            u && 'none' !== d && '' !== d
                ? ((s = l.getPropertyValue('content')),
                  ...
                  (n = ~['Solid', 'Regular', 'Light', 'Thin', 'Duotone', 'Brands', 'Kit'].indexOf(
                      u[2]
                  )
                      ? D[a][u[2].toLowerCase()]
                      : X[a][m]),
                ...
                hooks: function () {
                    return {
                        ...
                        watch: function (t) {
                            ...
                            Ra
                                ? ha()
                                : ka(Xt('mutationObserverCallbacks', { observeMutationsRoot: t }));
                        },
                    };
                },
            },
