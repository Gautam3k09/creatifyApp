...
export class SaveTeeModalComponent {
  ...
  profitPrice : any;
  helper : any = false;
  constructor(@Inject(MAT_DIALOG_DATA) public data: {isMerch: any,teeName:any,finalPrice:any,fromHelper:any},public dialogRef: MatDialogRef<SaveTeeModalComponent>) {    
